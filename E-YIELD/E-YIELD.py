...
# 4 = W_modified - W_original --> There must be a file work_function.txt produced

# Time to read the electron spectrum [fs]
time_to_read = None
# Default: None, it is going to analyze for the last time in the simulation
# Otherwise it is going to find the closest time to read from the data
...
# data_folder =[spectrum in Z, spectrum_material, DOS, Total All]
...
# Time study Folder
time_folder = plotting.create_time_analysis_folder(save_folder)
